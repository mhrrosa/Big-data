...
public class Exercicio5 {
    ...
    public static class MapMediaCommodityTipoAnoFluxo
        ...
        public void map(LongWritable key, Text value, Context con)
            ...
            if(!valores[1].equals("year") && valores[0].equals("Brazil") && valores[4].equals("Export")){
                con.write(new Text(valores[3] + " - " + valores[7] +" - "+ valores[9] + " - " + valores[1]+": "),new DoubleWritable(Double.parseDouble(valores[5])));
            }
        }
    }

    public static class ReduceMediaCommodityTipoAnoFluxo
